...
const CutoverPlanProcedure: React.FC = () => {
  return (
    <div className="space-y-10 text-gray-800">
      ...
      <div className="text-center">
        <div className="flex items-center justify-center gap-3">
            ...
            <h2 className="text-2xl md:text-3xl font-extrabold text-[#0A3130]">
                Plano de Cutover – Saída da Fase Realize
            </h2>
        </div>
      </div>
      ...
      <div className="bg-yellow-50 border-l-4 border-yellow-400 p-5 rounded-r-lg shadow-sm">
        <h3 className="flex items-center text-xl font-bold text-yellow-900 mb-2">
            ...
            Motivo – Documento de saída da fase de Realize
        </h3>
        <p className="text-yellow-800 leading-relaxed">
            Marca o fim da preparação técnica e organizacional, permitindo a virada segura da operação para o ambiente produtivo.
        </p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <p className="text-gray-700 leading-relaxed">
          Realizar a entrada em produção de forma segura, coordenada e controlada, com impacto mínimo à operação.
        </p>
      </div>
            ...
            <table className="w-full text-left">
                ...
                <tbody className="divide-y divide-gray-200">
                    <tr className="hover:bg-gray-50/50">
                        ...
                        <td className="p-4 text-gray-600"><strong>(R)</strong>esponsável por executar o plano técnico.</td>
                    </tr>
                    <tr className="hover:bg-gray-50/50">
                        <td className="p-4 font-medium text-gray-800">PMO</td>
                        <td className="p-4 text-gray-600"><strong>(C)</strong>onsultado para coordenar a comunicação.</td>
                    </tr>
                    <tr className="hover:bg-gray-50/50">
                    ...
                    <tr className="hover:bg-gray-50/50">
                        ...
                        <td className="p-4 text-gray-600"><strong>(A)</strong>provador da execução do cutover.</td>
                    </tr>
                </tbody>
            </table>
        </div>
      ...
      <div className="bg-[#e0f2fe] p-6 rounded-lg border border-[#3095A6]/50 text-center space-y-4 mt-8 transition-shadow hover:shadow-md">
         ...
         <p className="text-[#0A3130]">Utilize o template padrão para o Plano de Cutover.</p>
         <a
            href="https://gruposipal.sharepoint.com/:x:/r/sites/PMO/_layouts/15/Doc.aspx?sourcedoc=%7B7802F616-9CC6-4638-8A73-436162AEC0A9%7D&file=PMO-REA-007%20Plano%20de%20Cutover.xlsx&action=default&mobileredirect=true"
            target="_blank"
...
export default CutoverPlanProcedure;