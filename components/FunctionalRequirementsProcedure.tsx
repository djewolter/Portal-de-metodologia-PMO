    ...
    <div className="space-y-8 text-gray-800">
      ...
      <div className="text-center">
        <h2 className="text-2xl md:text-3xl font-extrabold text-[#0A3130]">
          Procedimento – Mapear Requisitos Funcionais (2.3)
        </h2>
      </div>
      ...
      <div className="space-y-2">
        ...
        <p className="text-gray-700 leading-relaxed">
          Garantir que as funcionalidades essenciais ao negócio estejam bem definidas, documentadas e acordadas com todas as partes envolvidas.
        </p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <p className="text-gray-700 leading-relaxed">
          Levantamento detalhado do que o sistema ou solução precisa realizar do ponto de vista do usuário e das áreas de negócio.
        </p>
      </div>
            ...
            <table className="w-full text-left">
                ...
                <tbody className="divide-y divide-gray-200">
                    <tr className="hover:bg-gray-50">
                        ...
                        <td className="p-4 text-gray-600"><strong>(R)</strong>esponsável por definir e validar os requisitos.</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                    ...
                    <tr className="hover:bg-gray-50">
                        <td className="p-4 font-medium text-gray-800">Analista de Negócios / Produto</td>
                        <td className="p-4 text-gray-600"><strong>(A)</strong>provador da documentação de requisitos.</td>
                    </tr>
                     <tr className="hover:bg-gray-50">
                        <td className="p-4 font-medium text-gray-800">Fornecedor</td>
                        <td className="p-4 text-gray-600"><strong>(I)</strong>nformado para entendimento da solução a ser desenvolvida.</td>
                    </tr>
                </tbody>
            </table>
        </div>
      ...
      <div className="bg-gray-50 p-6 rounded-lg border border-gray-200 text-center space-y-3">
         ...
         <p className="text-gray-600">Utilize o modelo padrão para a documentação de Requisitos Funcionais.</p>
         <a
