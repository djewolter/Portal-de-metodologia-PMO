...
const GoNoGoMeetingProcedure: React.FC = () => {
  return (
    <div className="space-y-8 text-gray-800">
      {/* Header */}
      <div className="text-center">
        <h2 className="text-2xl md:text-3xl font-extrabold text-[#0A3130]">
          Procedimento – Realizar Reunião Go/No Go (5.1)
        </h2>
      </div>
      ...
      <div className="space-y-2">
        ...
        <p className="text-gray-700 leading-relaxed">
          Reunião crítica para tomada de decisão quanto à entrada em produção. Avalia se todos os critérios técnicos, operacionais e de negócio foram atendidos.
        </p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <p className="text-gray-700 leading-relaxed">
          Formalizar a autorização para o Go Live com base em prontidão técnica, testes aprovados, plano de mudança definido e riscos controlados.
        </p>
      </div>
            ...
            <table className="w-full text-left">
                ...
                <tbody className="divide-y divide-gray-200">
                    <tr className="hover:bg-gray-50">
                        ...
                        <td className="p-4 text-gray-600"><strong>(R)</strong>esponsável por conduzir a reunião.</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                    ...
                    <tr className="hover:bg-gray-50">
                        ...
                        <td className="p-4 text-gray-600"><strong>(A)</strong>provador da decisão final (Go/No-Go).</td>
                    </tr>
                </tbody>
            </table>
        </div>
      ...
      <div className="bg-gray-50 p-6 rounded-lg border border-gray-200 text-center space-y-3">
         ...
         <p className="text-gray-600">
           Não há um documento específico para esta reunião. Para realizar a reunião Go/No Go, é necessário avaliar a prontidão para o Go Live.
         </p>
         <a
            ...
            aria-label="Abrir modelo de prontidão para Go Live"
          >
            <FileTextIcon className="h-5 w-5" />
            Modelo de Prontidão para Go Live
          </a>
      </div>
    </div>
  );
...
export default GoNoGoMeetingProcedure;
