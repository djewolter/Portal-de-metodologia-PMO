    ...
    <div className="space-y-8 text-gray-800">
      ...
      <div className="text-center">
        <h2 className="text-2xl md:text-3xl font-extrabold text-[#0A3130]">
          Procedimento – Executar Testes Integrados (4.4)
        </h2>
      </div>
      ...
      <div className="space-y-2">
        ...
        <p className="text-gray-700 leading-relaxed">
          Detectar falhas de integração, inconsistências de processo e problemas de usabilidade antes do Go Live.
        </p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <p className="text-gray-700 leading-relaxed">
          Validação de fluxos completos entre sistemas e áreas, simulando o uso real da solução implantada.
        </p>
      </div>
            ...
            <table className="w-full text-left">
                ...
                <tbody className="divide-y divide-gray-200">
                    <tr className="hover:bg-gray-50">
                        ...
                        <td className="p-4 text-gray-600"><strong>(R)</strong>esponsável por conduzir os testes.</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                        <td className="p-4 font-medium text-gray-800">Key Users</td>
                        <td className="p-4 text-gray-600"><strong>(C)</strong>onsultado para executar os cenários de teste.</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                        <td className="p-4 font-medium text-gray-800">PMO</td>
                        <td className="p-4 text-gray-600"><strong>(I)</strong>nformado sobre os resultados e pendências.</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
